package Algoritm.Algoritm.Search.ЭкспоненциальныйПоиск;

//Сложность по времени в наихудшем случае O(ln(k))
//
//k — Позиция искомого элемента в последовательности
// Дополненная версия бинарного поиска. Эффективна когда элемент находиться ближе к началу последовательности.
